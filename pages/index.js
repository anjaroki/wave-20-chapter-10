  ...
  return (
    <>
      ...
      <NavbarLayout>
            ...
            <div className="row justify-content-center">
              <div className="col-md-8 col-lg-10 col-xl-12">
                ...
                <div className="text-center story">
                  ...
                  <Image className="m-auto" src="/arrow-down-sign-to-navigate.png" height={30} width={30} alt="navigation" />
                </div>
              </div>
            </div>
          </div>
                ...
                <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
                  <div className="carousel-inner">
                    <div className="carousel-item active">
                      <Image className="d-block w-100" src="/rockpaperstrategy-1600.jpg" height={300} width={500} alt="First slide" />
                    </div>
                    <div className="carousel-item">
                      <Image className="d-block w-100" src="/main-bg.jpg" height={300} width={500} alt="Second slide" />
                    </div>
                  </div>
                      ...
                      <div className="card">
                        <div className="card-body p-0 mt-5">
                          <div className="feature-section-list">
                            ...
                            <p>if you miss your childhood, we provide so many traditional games here</p>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        {/* Requirements */}
        <div className="container-fluid requirement" id="requirements">
          <div className="container">
            <div className="row">
                        ...
                        <div className="card-top-scores">
                          <div className="testi-header">
                            <div className="avatar">
                              <Image className="img rounded-circle" src="/person1.jpg" width={50} height={50} alt="person" />
                            </div>
                    ...
                    <div className="col-md-12 col-lg-6 offset-lg-2">
                      <div className="d-flex flex-column align-items-center">
                        <div className="card-top-scores">
                          <div className="testi-header">
                            <div className="avatar">
                              <Image className="img rounded-circle" src="/person2.jpg" width={50} height={50} alt="person2" />
                            </div>
                            <div className="testimoni-info">
                    ...
                    <div className="col-md-12 col-lg-6 offset-lg-4">
                      <div className="d-flex flex-column align-items-center">
                        <div className="card-top-scores">
                          <div className="testi-header">
                            <div className="avatar">
                              <Image className="img rounded-circle" src="/person3.jpg" width={50} height={50} alt="Person3" />
                            </div>
                            <div className="testimoni-info">
              ...
              <div className="row align-self-center">
                ...
                <div className="col-lg-6">
                  ...
                  <h6 className="text-white" style={{ fontWeight: 300 }}>
                    In order to start receiving our news all you have to do is enter your email address. Everything else will no taken care of by us. We sill send you emails containing information about game. We don't spam.
                  </h6>
                  <div className="subscribe">
                    <h6>Your Email Address</h6>
                    <div className="form-email d-flex flex-row">
                      <input className="input-subs" type="text" placeholder="youremail@binar.co.id" />
                      <button className="btn btn-warning btnSubs">Subscribe Now</button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col">
                ...
                <p className="text-white">© Binar Academy 2022, Inc. All Rights Reserved</p>
              </div>
            </div>
          </div>
        </div>
